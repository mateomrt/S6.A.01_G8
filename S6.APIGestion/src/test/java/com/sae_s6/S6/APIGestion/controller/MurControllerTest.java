...
public class MurControllerTest {
    ...
    void testGetMurById() {
        ...
        assertThat(response.getBody().getSalle()).isNull(); // Salle peut être null pour les tests
    }

    @Test
    void testSaveMur() {
        Mur mur = createMur(102, "Type C");
        assertThat(mur.getTitre()).isEqualTo("Type C");
        assertThat(mur.getHauteur()).isEqualTo(300);
        assertThat(mur.getLongueur()).isEqualTo(500);
        assertThat(mur.getOrientation()).isEqualTo(1);
        assertThat(mur.getSalle()).isNull(); // Salle peut être null pour les tests
